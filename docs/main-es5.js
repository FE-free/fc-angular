...
var LayoutService = /** @class */ (function () {
    ...
    LayoutService.prototype.navMenu = function (router, menu, refresh) {
        ...
        if (menu.MENUTYPE === 'APP') {
            // 开启加载条
            var loadId_1 = this.messageService.loading('loading...').messageId;
            var params = {
                queryParams: {
                    refresh: refresh,
                    ID: menu.ID,
            ...
            router
                ...
                console.log(error);
                _this.messageService.remove(loadId_1);
...
var MOCK_MODULES = !_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].production ? [{ data: _mock__WEBPACK_IMPORTED_MODULE_7__ }] : [];
