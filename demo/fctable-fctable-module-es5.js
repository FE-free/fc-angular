...
var FcaggridComponent = /** @class */ (function () {
    function FcaggridComponent(router, activedRoute, http) {
        this.router = router;
        this.activedRoute = activedRoute;
        this.http = http;
    }
    FcaggridComponent.prototype.ngAfterViewInit = function () {
        throw new Error("Method not implemented.");
    };
    FcaggridComponent.prototype.ngOnInit = function () {
        throw new Error("Method not implemented.");
    };
