...
var isDeclarationLike = function (node) {
    return typescript_1.isAccessor(node) || typescript_1.isMethodDeclaration(node) || typescript_1.isParameterPropertyDeclaration(node) || typescript_1.isPropertyDeclaration(node);
};
